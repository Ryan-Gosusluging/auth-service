...
import (
	...
	authresponse "github.com/Ryan-Gususluging/auth-service/internal/controller/response/auth_response.go"
	"github.com/Ryan-Gususluging/auth-service/internal/entity"
